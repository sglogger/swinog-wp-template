...
<section id="plugin-sponsors" class="wp-block-group alignfull swinog-tiers-wrap swinog-plugin-wrap">
	...
	<!-- wp:group {"className":"swinog-tiers","align":"wide","layout":{"type":"default"}} -->
	<div class="wp-block-group alignwide swinog-tiers">

		<!-- wp:group {"className":"swinog-tiers__head","layout":{"type":"default"}} -->
		<div class="wp-block-group swinog-tiers__head">
